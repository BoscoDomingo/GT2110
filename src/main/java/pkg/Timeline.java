...
public class Timeline implements ITimeline, IMenu {
    ...
    public Timeline(ArrayList<Publicacion> publicaciones) {
        ...
        // una pÃ¡gina mÃ¡s de lo debido: 50/50 + 1 = 2, cuando deberÃ­a ser 1
    ...
    public void showLastPage() {
        ...
        if (currentIndex == 0) { //creo que nunca se da este caso
            System.out.println("No hay publicaciones disponibles en esta pÃ¡gina");
        }
        System.out.println("\n**************************************************\n");
    ...
    @Override
    public void showPage(int pageNumber) { //las pÃ¡ginas van de 1 en adelante
        System.out.println("\n********************TIMELINE**********************\n");
        if (pageNumber <= numeroDePaginas && pageNumber >= 1) {
            ...
            System.out.println("Lo siento, este Timeline no dispone de tantas pÃ¡ginas.\nVOLVIENDO AL MENU PREVIO");
        }
        System.out.println("\n**************************************************\n");
    }
            ...
            if (scan.hasNextInt()) {
                ...
                if (index >= 1) {
                    if ((currentPage < numeroDePaginas && index <= 50) || (currentPage == numeroDePaginas && 50 * (numeroDePaginas - 1) + (index - 1) < publicaciones.size())) {
                        //si no es la Ãºltima pÃ¡gina                     Si es Ãºltima pag, hay hay que tener cuidado de no irse del tamaÃ±o
                        ...
                        //si currentPage=2, index = 10, irÃ­amos a la 1*50 + 10-1= 59, que serÃ­a la 10Âª publicacion
                        // que ve el usuario.
