            ...
            switch (selector) {
                ...
                case 2:
                    ...
                    while (!valido && !abandonar) {
                        System.out.println(" \n--- Para abandonar el incio de sesion introduzca 'exit' en el primer " +
                                                   "campo. --- ");
                        System.out.println(
                                " --- Si ha olvidado su contraseña introduzca 'change' en el primer campo. --- ");
                        System.out.println(" --- Si quiere iniciar sesión introduzca su mail en el primer campo. ---");
                        System.out.println(
