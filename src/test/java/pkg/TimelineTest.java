...
public class TimelineTest {
    ...
    public void showTimelineByPages() {
        ...
        for (int i = 0; i < 101; i++) {
            publicaciones.add(
                    new Publicacion("b00" + i, new CuentaUsuario("a00" + i, "" + i, i + "@upm.es", null, null, null,
    ...
    public void showLastPage() {
        ArrayList<Publicacion> publicaciones = new ArrayList<>();
        publicaciones.add(
                new Publicacion("b00" + 1, new CuentaUsuario("a00" + 1, "" + 1, 1 + "@upm.es", null, null, null,
                                                             null, null), "Numero: " + 1, null, new ArrayList<>(),
                                null));
        Timeline timeline = new Timeline(publicaciones);
        System.out.println("\nMostrando la ultima pagina con 1 publicacion");
        timeline.showLastPage();
        for (int i = 2; i <= 100; i++) {
            publicaciones.add(
                    new Publicacion("b00" + i, new CuentaUsuario("a00" + i, "" + i, i + "@upm.es", null, null, null,
                                                                 null, null), "Numero: " + i, null, new ArrayList<>(),
        ...
        Timeline timeline2 = new Timeline(publicaciones);
        System.out.println("\nMostrando la ultima pagina con 100 publicaciones");
        timeline2.showLastPage();
        System.out.println("\nMostrando la ultima pagina con 101 publicaciones");
        publicaciones.add(new Publicacion("b0" + 101, new CuentaUsuario("a0" + 101, "" + 101, 101 + "@upm.es", null,
                                                                        null, null, null, null), "Numero: " + 101,
                                          null, new ArrayList<>(), null));
        Timeline timeline3 = new Timeline(publicaciones);
        timeline3.showLastPage();
    }

    @Test
    public void anyadirYBorrarPublicaciones() {
        //Tests de anyadir y borrar publicaciones
        System.out.println("-----------------Añadir Publicaciones-----------------");
        CuentaUsuario cuenta = new CuentaUsuario("c0031", "Mario", "mario@upm.es");
        Publicacion publicacion = new Publicacion("p0004", cuenta, "Usando twitterFIS!", new ArrayList<>(),
                                                  new ArrayList<>(), new ArrayList<>());
        Publicacion publicacion1 = new Publicacion("p0005", cuenta, "Es muy util", new ArrayList<>(), new ArrayList<>(),
                                                   new ArrayList<>());
        Publicacion publicacion2 = new Publicacion("p0006", cuenta, "It's a me Mario", new ArrayList<>(),
                                                   new ArrayList<>(), new ArrayList<>());
        Publicacion publicacion3 = new Publicacion("p0007", cuenta, "It's a me Luigi", new ArrayList<>(),
                                                   new ArrayList<>(), new ArrayList<>());
        ...
        timeline2.showLastPage();
        System.out.println("<<<<<<<<<Añadimos 1 publicacion>>>>>>>>>");
    ...
    public void probarSelectPublicacion() {
        ...
        //COPIAMOS Y PEGAMOS CÓDIGO PORQUE NO PODEMOS PROBAR INPUT POR PANTALLA
        int index = 36;
        ...
        if (index >= 1) {
            if ((currentPage < numeroDePaginas && index <= 50) || (currentPage == numeroDePaginas && 50 * (numeroDePaginas - 1) + (index - 1) < publicaciones5.size())) {
                ...
                System.out.println(
                        "Se ejecutaria ahora el menu de la publicacion seleccionada, correspondiente a otra clase");
    ...
    public void probarOpcionesMenu() {
        ...
        System.out.println("\nProbando opcion 3: seleccionar una publicacion");
